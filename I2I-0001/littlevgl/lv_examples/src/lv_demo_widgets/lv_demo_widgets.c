...
void lv_demo_widgets(void)
{
    ...
    t4 = lv_tabview_add_tab(tv, "Visuals");
	t5 = lv_tabview_add_tab(tv, "Selectors");
...
//********************************************************************************************************
    ...
    lv_obj_t * led = lv_led_create(source01, NULL);
...
//********************************************************************************************************
    ...
    led = lv_led_create(source02, NULL);
    lv_obj_set_size(led, led_size, led_size);
    if (led2active == 1)
    {
    	lv_led_set_bright(led, LV_LED_BRIGHT_MAX);
...
//********************************************************************************************************
    ...
    led = lv_led_create(source03, NULL);
    lv_obj_set_size(led, led_size, led_size);
    if (led3active == 1)
    {
    	lv_led_set_bright(led, LV_LED_BRIGHT_MAX);
