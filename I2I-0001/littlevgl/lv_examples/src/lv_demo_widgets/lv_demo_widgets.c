...
static void debugupdate_anim(lv_task_t * t)
{
	...
	snprintf(str01, 5, "%i", adcbattery);
	snprintf(str02, 5, "%i", adcin1v);
	snprintf(str03, 5, "%i", adcin1a);
	snprintf(str04, 5, "%i", adcin2v);
	snprintf(str05, 5, "%i", adcin2a);
	snprintf(str06, 5, "%i", adcin3v);
	snprintf(str07, 5, "%i", adcin3a);
	snprintf(str08, 5, "%i", adcout1v);
	snprintf(str09, 5, "%i", adcout1a);
	snprintf(str10, 5, "%i", adcout2v);
	snprintf(str11, 5, "%i", adcout2a);
	snprintf(str12, 5, "%i", adcout3v);
	snprintf(str13, 5, "%i", adcout3a);
